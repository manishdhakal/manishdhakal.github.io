...
Publications at premier venues, such as \lbf{WACV, MICCAI, ACCV, IJCNLP-AACL, CVPR-W} etc.
\end{section}

\begin{section}{Education}
    \begin{subsection}{Ph.D. in Industrial Engineering}{University of Tennessee, Knoxvile}{Graduate School}{August 2026 -- 2029*}
        \item[] {\textit{Supervisor:} \lbf{\href{https://ding1.com/}{Yi Ding, Ph.D.}}}
        % \item Deep learning projects on \lbf{2D/3D computer vision and large language models (LLMs)}.
        \item Research in \lbf{efficient machine learning} and \lbf{model compression.}
    \end{subsection}
    \begin{subsection}{Master's in Computer Science}{Georgia State University}{Graduate School}{August 2024 -- July 2026}
        % \item[] {\textit{Supervisor:} \lbf{\href{https://ding1.com/}{Yi Ding, Ph.D.}}}
...
\begin{section}{Publications}
    \begin{subsection}
    {2022-Present}{}{}{\href{https://scholar.google.com/citations?user=lhGdC2IAAAAJ}{\underline{Scholar}} Citations: 130+ \& h-index: 4}
        \item Poudel, S., Kunwor, N., Simkhada, R., Munir, M., \lbf{\underline{Dhakal, M.}}, \& Poudel, K. (2026, June). Parameter efficient fine-tuning for domain-specific gastrointestinal disease recognition. In \textit{PHAROS @ CVPR.} [\href{https://arxiv.org/abs/2604.10451}{Paper}, \href{https://github.com/sanjay931/peft-gi-recognition}{Code}]

        \item \lbf{\underline{Dhakal, M.}}, Dasari, V. R., Sunderraman, R., \& Ding, Y. (2026, March). GFT: Graph feature tuning for efficient point cloud analysis. In \textit{WACV.} [\href{https://openaccess.thecvf.com/content/WACV2026/html/Dhakal_GFT_Graph_Feature_Tuning_for_Efficient_Point_Cloud_Analysis_WACV_2026_paper.html}{Paper}, \href{https://github.com/manishdhakal/GFT}{Code}]
        
        \item \lbf{\underline{Dhakal, M.}}, Jinadu, U., Budathoki, A., Sunderraman, R., \& Ding, Y. (2026, February). DistillLens: Symmetric knowledge distillation through logit lens. \textit{arXiv preprint arXiv:2602.13567.} [\href{https://arxiv.org/abs/2602.13567}{Paper}, \href{https://github.com/manishdhakal/DistillLens}{Code}]

        \item Mim, S. T., Morris, J., \lbf{\underline{Dhakal, M.}}, Xiu, Y., Gorlatova, M., \& Ding, Y. (2025, December). Can a unimodal language agent provide preferences to tune a multimodal vision-language model? In \textit{IJCNLP-AACL Findings.} [\href{https://aclanthology.org/2025.findings-ijcnlp.133}{Paper}]
...
\begin{section}{References (Research Advisors)}
    \begin{subsectionnobullet}
        {Yi Ding, Ph.D.}{ {\normalfont Assistant Professor,} Department of Industrial and Systems Engineering, University of Tennessee Knoxville}{}{}
        \item{\href{mailto:yding@utk.edu}{\ttfamily yding@utk.edu}}
