...
Applied Deep Learning Researcher working at the intersection of \lbf{Computer Vision, LLMs, and Model Compression} (Knowledge Distillation, PEFT). Expertise in \lbf{Multimodal}, \lbf{3D Point Cloud}, and \lbf{Medical Imaging} data for robust, resource-efficient systems.
\end{section}

\begin{section}{Education}
    \begin{subsection}{M.S. in Computer Science}{Georgia State University}{}{August 2024 -- May 2026}
        ...
        \item Research in \lbf{efficient machine learning \& model compression.}
        \italicitem{Grade: 4.0/4.0}
        % \item Awarded with \lbf{graduate research assistantship (GRA)} from the computer science department.
    \end{subsection}
    ...
    \begin{subsection}{Bachelor in Computer Engineering}{Pulchowk Campus, Institute of Engineering, Tribhuvan University}{Undergraduate School}{November 2017 -- April 2022}
        \item[] {\textit{Thesis Supervisor:} \lbf{\href{https://scholar.google.com/citations?user=ZB6i0OKaPo4C}{Subarna Shakya, Ph.D.}}}
        \item \lbf{Ranked 11\textsuperscript{th} (top 0.1\%)} in the engineering entrance exam, competing with \lbf{15,000+ candidates}, received \lbf{full scholarship} for undergraduate studies.
...
\begin{section}{Ongoing Projects}
    ...
    \item LLM-centric VLM adaptation method where the LLM itself provides preference feedmanback to optimize the textual descriptions.
    \end{subsection}
    
    \begin{subsection}{Parameter Efficient Fine-Tuning}{Point Cloud}{}{}
        \item \lbf{Graph Features Tuning (GFT)}, a Parameter-Efficient Fine-Tuning (PEFT) method specifically for point cloud data, reducing computational and memory costs compared to earlier approaches.
...
\begin{section}{Publications}
    \begin{subsection}
    {2022-Present}{}{}{\href{https://scholar.google.com/citations?user=lhGdC2IAAAAJ}{\underline{Scholar}} Citations: 70+ \& h-index: 4}
        \item {[Preprint] Budathoki, A., \& \lbf{\underline{Dhakal, M.}} (2025). \href{https://arxiv.org/abs/2505.02971}{Adversarial Robustness Analysis of Vision-Language Models in Medical Image Segmentation.} arXiv preprint arXiv:2505.02971. \href{https://github.com/anjilab/secure-private-ai}{\underline{[Code]}}}
        \item {Adhikari, R., Thapaliya, S.,\lbf{\underline{ Dhakal, M.}}, \& Khanal, B. (2024). \href{https://openaccess.thecvf.com/content/ACCV2024/html/Adhikari_TuneVLSeg_Prompt_Tuning_Benchmark_for_Vision-Language_Segmentation_Models_ACCV_2024_paper.html}{TuneVLSeg: Prompt Tuning Benchmark for Vision-Language Segmentation Models.} In Proceedings of the Asian Conference on Computer Vision (pp. 126-144). \href{https://github.com/naamiinepal/tunevlseg}{\underline{[Code]}}}
        % \item {Adhikari, R., Thapaliya, S., \lbf{\underline{Dhakal, M.}}, \& Khanal, B. (2024). \href{https://github.com/naamiinepal/tunevlseg}{TuneVLSeg: Prompt Tuning Benchmark for Vision-Language Segmentation Models.} arXiv preprint arXiv:2410.05239. \footnote{\url{https://github.com/naamiinepal/tunevlseg}}}
        \item {\lbf{\underline{Dhakal, M.}}, Adhikari, R., Thapaliya, S., \& Khanal, B. (2024). \href{https://arxiv.org/abs/2405.06196}{Finetuning Vision-Language Segmentation Efficiently with Lightweight Blocks.} In International Conference on Medical Image Computing and Computer-Assisted Intervention (pp. 712-722). Cham: Springer Nature Switzerland. \href{https://github.com/naamiinepal/vlsm-adapter}{\underline{[Code]}}}
        \item {Adhikari, R.*, \lbf{\underline{Dhakal, M.*}}, Thapaliya, S.*, Poudel, K., Bhandari, P., \& Khanal, B. (2023, October). \href{https://arxiv.org/abs/2309.12829}{Synthetic Boost: Leveraging Synthetic Data for Enhanced Vision-Language Segmentation in Echocardiography.} \textit{In International Workshop on Advances in Simplifying Medical Ultrasound} (pp. 89-99). Cham: Springer Nature Switzerland. \href{https://github.com/naamiinepal/synthetic-boost}{\underline{[Code]}}}
        \item {Poudel, K.*, \lbf{\underline{Dhakal, M.*}}, Bhandari, P.*, Adhikari, R.*, Thapaliya, S.*, \& Khanal, B. (2023). \href{https://proceedings.mlr.press/v250/poudel24a.html}{Exploring Transfer Learning in Medical Image Segmentation using Vision-Language Models.} \textit{In Medical Imaging with Deep Learning.} PMLR, 2024. \href{https://github.com/naamiinepal/medvlsm}{\underline{[Code]}}}
        \item {\lbf{\underline{Dhakal, M.}}, Chhetri, A., Gupta, A. K., Lamichhane, P., Pandey, S., \& Shakya, S. (2022, July). \href{https://arxiv.org/abs/2406.17825}{Automatic speech recognition for the Nepali language using CNN, bidirectional LSTM and ResNet.} \textit{In 2022 International Conference on Inventive Computation Technologies (ICICT)} (pp. 515-521). IEEE.\href{https://github.com/manishdhakal/ASR-Nepali-using-CNN-BiLSTM-ResNet}{\underline{[Code]}}}
    \end{subsection}
\end{section}
...
\sectiontable{Achievements/Services}{
    ...
    \entry{2024}{\lbf{Presidential Fellowship} by the TCV initiative at GSU (Only 6\% of the doctoral students).}
...
\begin{section}{References (Research Advisors)}
    \begin{subsectionnobullet}
        {Yi Ding, Ph.D.}{ {\normalfont Assistant Professor,} Department of Computer Science, Georgia State University}{}{}
    ...
    \end{subsectionnobullet}
    \begin{subsectionnobullet}
        {Subarna Shakya, Ph.D.}{ { \normalfont Professor of Computer Engineering,} Department of Electronics and Computer Engineering, Pulchowk Campus, Institute of Engineering, Tribhuvan University}{}{}
        \item{ \href{mailto:drss@ioe.edu.np}{ \ttfamily drss@ioe.edu.np}}
    \end{subsectionnobullet}
    \begin{subsectionnobullet}
        {Taman Upadhaya, Ph.D.}{ {\normalfont Associate Researcher,} University of California San Francisco {\normalfont \textbf{||} Adjunct Research Scientist,} Nepal Applied Mathematics and Informatics Institute for research (NAAMII)}{}{}
        \item{\href{mailto:taman.upadhaya@naamii.org.np}{\ttfamily taman.upadhaya@naamii.org.np}}
    \end{subsectionnobullet}
